...
with DAG(
    ...
    # trigger the next DAG when the parent DAG is completed successfully
    ...
    playlist_id >> video_ids >> extracted_data >> save_to_json_raw >> trigger_update_db
...
with DAG(
    ...
    # schedule="0 16 * * *", WE DON'T NEED THE SCHEDULE ANYMORE
    catchup=False   
) as dag_update:
    #Define tasks
